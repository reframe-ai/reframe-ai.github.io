...
const T = {
  ko: {
    ...
    certs: ['AI특화인재양성교육 - AI서비스개발 이수', 'AICE(AI 활용능력) BASIC', 'NCS 강사', '직업능력훈련교사(영상분야)', '디지털 튜터', 'Google Workspace for Education Fundamentals', '평생교육사 2급', '사회복지사 1급'],
  ...
  en: {
    ...
    certs: ['AI Specialist Program - AI Service Development', 'AICE Basic (KT)', 'NCS Instructor', 'Vocational Training Teacher (Video)', 'Digital Tutor', 'Google Workspace for Education Fundamentals', 'Lifelong Educator Lv.2', 'Social Worker Lv.1'],
