...
const T = {
  ko: {
    ...
    h2_accent: '가능성을',
    h2_rest: ' 열다.',
    sub: '천천히, 제대로 배우는 AI 교육 — Re:Frame은 도구 사용법을 넘어 AI와 함께 생각하고 만드는 힘을 키웁니다. 처음 배우는 시니어부터 실무에 적용하려는 직장인까지, 누구나 자기 속도로 배우도록 설계합니다.',
    cta1: '강의 분야 보기',
    cta2: '강사진 보기',
    cta3: '강의 문의하기',
  ...
  en: {
    ...
    h2_accent: 'together',
    h2_rest: ' with AI.',
    sub: 'Slow, steady, real AI education — Re:Frame builds the power to think and create with AI, beyond tool skills. Designed so anyone, from first-time seniors to working professionals, can learn at their own pace.',
    cta1: 'Lecture Areas',
